...
SelfSEEDHuman = TypeVar("SelfSEEDHuman", bound="SEEDHuman")
...
class SEEDHuman(OffPolicyAlgorithm):
    ...
    def collect_rollouts(
        ...
        while should_collect_more_steps(train_freq, num_collected_steps, num_collected_episodes):
            ...
            print("Enter Human Feedback: ")
            human_reward_int = float(input())
            human_rewards = np.array(human_reward_int)
    ...
    def _store_transition(
        ...
        if new_obs is not None:
            ...
            if self._vec_normalize_env is not None:
                self._last_original_obs = new_obs
